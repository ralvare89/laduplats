...
export default function WhatsAppFAB() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 bg-black text-white text-xs px-3 py-1.5 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none border border-zinc-700">
        Escríbenos
      </span>
    </a>
  )
