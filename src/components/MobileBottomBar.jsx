...
const ITEMS = [
  ...
  {
    label: 'Email',
    href: 'mailto:ralvare89@gmail.com',
    activeColor: '#F59E0B',
    icon: (
...
export default function MobileBottomBar() {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-[170] bg-zinc-950/95 backdrop-blur-md border-t border-zinc-800">
      <div className="flex items-stretch">
        {ITEMS.map((item) => (
          <a
            ...
            title={item.label}
            className="flex-1 flex flex-col items-center justify-center gap-1 py-3 text-zinc-500 transition-colors active:scale-95"
            style={{ '--active-color': item.activeColor }}
            onTouchStart={e => e.currentTarget.style.color = item.activeColor}
      ...
      <div className="h-safe-bottom bg-zinc-950/95" style={{ height: 'env(safe-area-inset-bottom)' }} />
    </div>
  )
}
